...
return [
    ...
    | например, правила размера. Вы можете свободно изменять каждое из этих сообщений здесь.
    |
    */
    ...
    'lte' => [
        'array' => 'Поле :attribute не “

должно содержать больше :value элементов.',
    ...
    'password' => [
        ...
        'uncompromised' => 'Указанное значение :attribute было скомпрометировано в утечке данных. Пожалуйста, выберите другое :attribute.',
    ],
    ...
    */
    ...
    | на более удобочитаемые варианты, такие как "Адрес электронной почты" вместо
